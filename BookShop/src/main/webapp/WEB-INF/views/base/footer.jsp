	...
	<div class="footer-category">
		<div class="container">
			<div class="category-toggle">
				<a href="javascript:void(0);" class="toggle-btn">Danh mục sách</a>
				<div class="toggle-items row book-grid-row">
					<div class="footer-col-book">
						<ul>
							<c:forEach var="cat" items="${applicationScope.categories}">
								<li><a
									href="${pageContext.request.contextPath}/books?categoryId=${cat.id}">
										${cat.name} </a></li>
							</c:forEach>
						</ul>
					</div>
			...
			<div class="row">
				<div class="col-xl-3 col-lg-12">
					<div class="widget widget_about">
						...
						<p class="text">Góc Sách là website thương mại điện tử bán
							sách trực tuyến, cung cấp đa dạng đầu sách chất lượng.</p>
				...
				<div class="col-xl-2 col-lg-3 col-sm-4 col-4">
					<div class="widget widget_services">
						<h5 class="footer-title">Góc Sách ?</h5>
						<ul>
							<li><a href="services.html">Dịch vụ</a></li>
							<li><a href="books-detail.html">Chi tiết sách</a></li>
							<li><a href="blog-detail.html">Chi tiết blog</a></li>
							<li><a href="books-grid-view.html">Cửa hàng</a></li>
						</ul>
					</div>
				</div>
				<div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-4">
					<div class="widget widget_services">
						...
						<ul>
							<li><a href="services.html">Tải xuống</a></li>
							<li><a href="help-desk.html">Trung tâm hỗ trợ</a></li>
							<li><a href="shop-cart.html">Giỏ hàng</a></li>
							<li><a href="shop-login.html">Đăng nhập</a></li>
							<li><a href="about-us.html">Đối tác</a></li>
						</ul>
					</div>
				</div>
				<div class="col-xl-3 col-lg-3 col-md-12 col-sm-12">
					<div class="widget widget_getintuch">
						...
						<ul>
							<li><i class="flaticon-placeholder"></i> <span>832
									Đường 123 quận A,HCM</span></li>
							<li><i class="flaticon-phone"></i> <span>+123 345123
									556<br> +123 345123 556
							</span></li>
							<li><i class="flaticon-email"></i> <span>support@gocsach.id<br>
									info@gocsach.id
							</span></li>
						</ul>
					</div>
			...
			<div class="row fb-inner">
				<div class="col-lg-6 col-md-12 text-start">
					<p class="copyright-text">
						Bookland Book Store Ecommerce Website - © <span
							class="current-year">2026</span> All Rights Reserved
					</p>
				</div>
				<div class="col-lg-6 col-md-12 text-end">
					<p>
						Made with <span class="heart"></span> by <a
							href="https://dexignzone.com/">DexignZone</a>
					</p>
				</div>
			</div>
		</div>
...
<!-- BOOTSTRAP MIN JS -->
<script
	src="${pageContext.request.contextPath}/assets/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
<!-- BOOTSTRAP SELECT MIN JS -->
<script
	src="${pageContext.request.contextPath}/assets/vendor/swiper/swiper-bundle.min.js"></script>
<!-- SWIPER JS -->
<script
	src="${pageContext.request.contextPath}/assets/vendor/countdown/counter.js"></script>
<!-- COUNTER JS -->
<script
	src="${pageContext.request.contextPath}/assets/vendor/counter/waypoints-min.js"></script>
<!-- WAYPOINTS JS -->
<script
	src="${pageContext.request.contextPath}/assets/vendor/counter/counterup.min.js"></script>
<!-- COUNTERUP JS -->
<script
	src="${pageContext.request.contextPath}/assets/vendor/wnumb/wNumb.js"></script>
<!-- WNUMB -->
<script
	src="${pageContext.request.contextPath}/assets/vendor/nouislider/nouislider.min.js"></script>
<!-- NOUSLIDER MIN JS-->

<script
	src="${pageContext.request.contextPath}/assets/js/dz.carousel.js"></script>
<!-- DZ CAROUSEL JS -->

<script src="${pageContext.request.contextPath}/assets/js/dz.ajax.js"></script>
<!-- AJAX -->
<script src="${pageContext.request.contextPath}/assets/js/custom.js"></script>
<!-- CUSTOM JS -->

<script id="DZScript"
	src="https://dzassets.s3.amazonaws.com/w3-global-2.0.js?token=W-2478e29fe9f1dec7107f88b5507c1da0"></script>
<style>
.DZ-theme-btn {
...
<a rel="nofollow" href="https://1.envato.market/0J6EoR" target="_blank"
	class="DZ-bt-buy-now DZ-theme-btn"><svg height="40"
		viewBox="0 -31 512.00026 512" width="40"
		...
		<path
			d="m362 405c0 24.8125 20.1875 45 45 45s45-20.1875 45-45-20.1875-45-45-45-45 20.1875-45 45zm45-15c8.269531 0 15 6.730469 15 15s-6.730469 15-15 15-15-6.730469-15-15 6.730469-15 15-15zm0 0"></path></svg><span>Buy
		Now</span></a>
<a href="https://support.w3itexperts.com" target="_blank"
	class="DZ-bt-support-now DZ-theme-btn"><svg id="Capa_1"
		enable-background="new 0 0 512 512" height="40" viewBox="0 0 512 512"
...
<script>
	setTimeout(function() {
		...
		document.getElementById('manualMin').addEventListener('change',
				function() {
		...
		document.getElementById('manualMax').addEventListener('change',
				function() {
					var val = parseFloat(this.value);
					if (!isNaN(val))
